...
class ProfileCompletionForm(forms.Form):
    ...
    city = forms.CharField(required=False, label="Thành phố", widget=forms.TextInput(attrs={"placeholder": "Thành phố"}))
    state = forms.CharField(required=False, label="Tỉnh/Quận", widget=forms.TextInput(attrs={"placeholder": "Tỉnh/Quận"}))
    postal_code = forms.CharField(required=False, label="Mã bưu chính", widget=forms.TextInput(attrs={"placeholder": "Mã bưu chính"}))
